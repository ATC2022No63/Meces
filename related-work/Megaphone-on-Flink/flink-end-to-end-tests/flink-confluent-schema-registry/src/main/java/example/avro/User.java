...
public class User extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
    ...
    throws java.io.IOException
  {
    ...
    out.writeString(this.favoriteNumber);
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      this.favoriteNumber = in.readString(this.favoriteNumber instanceof Utf8 ? (Utf8)this.favoriteNumber : null);

      this.favoriteColor = in.readString(this.favoriteColor instanceof Utf8 ? (Utf8)this.favoriteColor : null);

      this.eventType = example.avro.EventType.values()[in.readEnum()];
