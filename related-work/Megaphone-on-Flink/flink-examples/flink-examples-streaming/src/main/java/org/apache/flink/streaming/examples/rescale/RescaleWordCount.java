...
public class RescaleWordCount {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String kafkaServers = params.get("kafkaServers", "slave205:9092,slave206:9092");
        ...
        FlinkKafkaConsumer<String> consumer =
                new FlinkKafkaConsumer<>(params.get("topic", "wordcount2"), new SimpleStringSchema(), props);
        ...
        env.enableCheckpointing(Integer.MAX_VALUE).disableOperatorChaining();
