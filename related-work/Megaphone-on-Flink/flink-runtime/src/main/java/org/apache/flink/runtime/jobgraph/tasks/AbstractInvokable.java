...
public abstract class AbstractInvokable {
     ...
     *
     * @throws Exception Tasks may forward their exceptions for the TaskManager to handle through failure/recovery.
     */
    ...
    public void resumeSource() throws FlinkException {
        throw new UnsupportedOperationException("dispatchOperatorEvent not supported by " + getClass().getName());
    }

    public void broadcastBatchSignal(EndOfBatchEvent endOfBatchEvent) throws FlinkException {
        throw new UnsupportedOperationException("dispatchOperatorEvent not supported by " + getClass().getName());
    }

    public void broadcastMigrationSignal() throws FlinkException {
        throw new UnsupportedOperationException("dispatchOperatorEvent not supported by " + getClass().getName());
    }

    public BinaryState getState(int index) throws Exception {
        throw new UnsupportedOperationException("dispatchOperatorEvent not supported by " + getClass().getName());
    }
