...
public final class KeyGroupRangeAssignment {
    ...
    public static int toNewIndex(int kg, int maxParallelism, int parallelism) {
        int oldIndex = computeOperatorIndexForKeyGroup(maxParallelism, parallelism, kg);
        int newIndex = (oldIndex + 1) % parallelism;
        return newIndex;
    }
}
