...
public class FsStateBackend extends AbstractFileStateBackend implements ConfigurableStateBackend {
    ...
    protected static final Logger LOG = LoggerFactory.getLogger(FsStateBackend.class);
    ...
    public <K> AbstractKeyedStateBackend<K> createKeyedStateBackend(
        ...
        this.keyedStateBackends.put(stateName, keyedStateBackend);
    ...
    public BinaryState extractState(int index) throws IOException, FlinkException {
        OperatorStatePartition[] operatorStatePartitions = keyedStateBackends.values().stream().
                findFirst().get().extractState(index);
