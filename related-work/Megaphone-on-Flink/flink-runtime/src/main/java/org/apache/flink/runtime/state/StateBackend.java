...
public interface StateBackend extends java.io.Serializable {
	...
	default BinaryState extractState(int index) throws FlinkException, IOException {
		throw new UnsupportedOperationException(
				"operation not supported by " + getClass().getName());
	}

	default Set<String> getStateDescriptor() throws FlinkException, IOException {
		throw new UnsupportedOperationException(
				"operation not supported by " + getClass().getName());
	}
	...
	default void applyState(byte[] bytes) throws FlinkException, IOException {
		throw new UnsupportedOperationException(
				"operation not supported by " + getClass().getName());
	}

	default void insertKG(int index) throws FlinkException, IOException {
		throw new UnsupportedOperationException(
				"operation not supported by " + getClass().getName());
	}

	default void removeKG(int index) throws FlinkException, IOException {
		throw new UnsupportedOperationException(
				"operation not supported by " + getClass().getName());
	}
