...
public class FsStateBackend extends AbstractFileStateBackend implements ConfigurableStateBackend {
    ...
    public <K> AbstractKeyedStateBackend<K> createKeyedStateBackend(
        ...
        HeapKeyedStateBackend<K> keyedStateBackend = new HeapKeyedStateBackendBuilder<>(
                kvStateRegistry,
                keySerializer,
        ...
        StateDescriptor info = new StateDescriptor(
                ...
                keyGroupRange);
        checkNotNull(keyedStateBackend, "null hkbe");
        this.keyedStateBackends.put(info, keyedStateBackend);
    ...
    public void applySnapshot(byte[] bytes, boolean full) throws FlinkException, IOException {
        ...
        for (int i = 0; i < nstate; i++) {
            ...
            dd.read(buffer);
            if (keyedStateBackends.containsKey(metaHeader)) {
                KeyedStateBackend ksb = keyedStateBackends.get(meta);
                ksb.applySnapshot(buffer, full);
            }
        }
