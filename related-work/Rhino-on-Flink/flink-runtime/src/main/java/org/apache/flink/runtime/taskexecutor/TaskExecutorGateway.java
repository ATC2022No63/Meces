...
public interface TaskExecutorGateway extends RpcGateway, TaskExecutorOperatorEventGateway {
    ...
    default CompletableFuture<Acknowledge> startReplication(int epoch){return null;}
    default CompletableFuture<Acknowledge> prepareForRescaling(rescalePlan plan){return null;}
    default CompletableFuture<Acknowledge> triggerSignal(ExecutionAttemptID eid){return null;}
}
