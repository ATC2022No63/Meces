...
public interface StateBackend extends java.io.Serializable {
    ...
    default Map<StateDescriptor, OperatorStatePartition> getSnapshot(boolean isFull) throws FlinkException, IOException {
        throw new UnsupportedOperationException(
                "operation not supported by " + getClass().getName());
    }

    default Set<StateDescriptor> getStateDescriptor() throws FlinkException, IOException {
        throw new UnsupportedOperationException(
                "operation not supported by " + getClass().getName());
    }

    default void changeKeyGroupRange(int maxparallelism, int parallelism, int newIndex) throws FlinkException, IOException {
        throw new UnsupportedOperationException("dispatchOperatorEvent not supported by " + getClass().getName());
    }

    default void applySnapshot(byte[] bytes,boolean full) throws FlinkException, IOException {
        throw new UnsupportedOperationException(
                "operation not supported by " + getClass().getName());
    }

    default void applyIncremental(byte[] bytes,int newIndex) throws FlinkException, IOException {
        throw new UnsupportedOperationException(
                "operation not supported by " + getClass().getName());
    }
}
