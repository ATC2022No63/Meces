 ...
 * override {@link (CheckpointMetaData, CheckpointOptions, boolean)}, {@link
...
public abstract class AbstractInvokable {
    ...
    public BinaryState getSnapshot(boolean isFull) throws FlinkException, IOException {
        throw new UnsupportedOperationException(
                "operation not supported by " + getClass().getName());}
    ...
    public void triggerSignal() throws FlinkException {
        throw new UnsupportedOperationException(
                "operation not supported by " + getClass().getName());
    }
    public void aligned(){}

    public void changeKeyGroupRange(int newIndex) throws FlinkException, IOException {
    ...
    public void setReplicationManager(ReplicationManager manger) throws FlinkException, IOException {
        throw new UnsupportedOperationException("dispatchOperatorEvent not supported by " + getClass().getName());
    }

    public void applyIncrementalSnapshot(StateDescriptor state) throws FlinkException, IOException {
        throw new UnsupportedOperationException("dispatchOperatorEvent not supported by " + getClass().getName());
    }
