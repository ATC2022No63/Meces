...
public interface TaskManagerGateway extends TaskExecutorOperatorEventGateway {
    ...
    default void prepareForRescaling(rescalePlan plan){return ;}
    default void triggerSignal(ExecutionAttemptID eid){return ;}
    default CompletableFuture<Void> startReplication(int epoch){return null;}
}
