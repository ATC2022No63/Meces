...
public abstract class CheckpointBarrierHandler implements Closeable {
    ...
    public void freezeChannel(InputChannelInfo info) throws Exception {
        System.out.printf("error:%s\n",toString());
        throw new FlinkException("not implemented");}

    public void resumeAll() throws Exception {throw new CloneNotSupportedException();}
}
